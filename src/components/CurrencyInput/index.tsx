...
import useCurrencyFormat, { CurrencyFormatProps } from '../../hooks/useCurrencyFormat';

type omitFields = "type" | "onClick" | "onKeyDown" | "onChange";

export interface CurrencyInputProps extends Omit<InputHTMLAttributes<HTMLInputElement>, omitFields> {
...
export const CurrencyInput:React.FC<CurrencyInputProps> = ({children, value, options, onChangeEvent, ...otherProps}) => {
    const [
        formattedValue, 
        handleOnChange,
        handleOnKeyDown, 
